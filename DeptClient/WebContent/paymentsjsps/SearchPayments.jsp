...
<a style="color:purple; font-family: fantasy;font-size: 25px;font-style: normal;font-weight:100;" href="AddOrSearchPayment.jsp">HOME</a>

</div>	       
		<div  class="form" >
    		<form id="add" action="../PaymentSelect" method="post"> 
...
{
	 %>
 <jsp:include page="SelectAllPayment.jsp"></jsp:include>
<%} %>    
</div>
