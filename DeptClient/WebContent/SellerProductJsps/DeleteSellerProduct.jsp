...
<body background="SellerProductJsps/images/bgnoise_lg.png"> 
...
<div align="center">
<form action="SelectAllProductSellerServlet"> 
...
$(document).ready(function(){
	...
	$('#cancel').click(function(){
		window.location.replace("/DeptClient/SellerProductJsps/SearchSellerProduct.jsp");
