...
<a style="color:purple; font-family: fantasy;font-size: 25px;font-style: normal;font-weight:100;" href="sellerAddOrSearch.jsp">HOME</a>
...
<div >
	<!--/ freshdesignweb top bar -->
		...
		<div  class="form" >
    		<form id="add" action="../SelectAllSellerServlet"> 			
...
$(document).ready(function(){
	...
	<jsp:include page="/SelectAllSellerServlet"></jsp:include>
